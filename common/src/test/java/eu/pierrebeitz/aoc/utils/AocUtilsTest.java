...
class AocUtilsTest {
    ...
    public void readByGroupAndMapToObjectTest(
            BufferedReader input, Function<String, String> mapper, List<String> output) throws IOException {
    ...
    static Stream<Arguments> generateReadByGroupAndMapToObjectData() {
        return Stream.of(
                Arguments.of(
                        loadResource("readByGroupAndMapToObjectTest-1.txt"),
                        (Function<String, String>) s -> s,
                        Arrays.asList("abc\n", "def\n")),
                Arguments.of(
                        loadResource("readByGroupAndMapToObjectTest-2.txt"),
                        (Function<String, String>) s -> "toto" + s,
                        Arrays.asList("totoabc\n", "totodef\n")),
                Arguments.of(
                        loadResource("readByGroupAndMapToObjectTest-3.txt"),
                        (Function<String, String>) s -> s,
                        Arrays.asList("abc\ndef\n", "ghi\n")));
    }
